...
var URL = 'http://api.openweathermap.org/data/2.5/weather?q=new+york,us&units=imperial&APPID=bf051e197da4655b52447684d8d279d3'
...
function handleSuccess(response) {
  ...
  $('#nyc-weather').append(response.main.humidity + ' ')
  $('#nyc-weather').append(response.wind.speed + ' ')

  if (response.main.temp > 70) {
    //weather is good - mayor is smiles 
    $('body').css('background', 'red')
  } else {
    $('body').css('background', 'blue')
  }
}  
  //background: url(https://nyoobserver.files.wordpress.com/2014/11/457792700.jpg?quality=80);
